    ...
    <main class="container admin" id="content">
      ...
      <div class="admin-article">
        <section class="image">
          ...
          <?php } else { ?>
            <label>Image:</label>
            <img src="../uploads/<?= escape($article['image_file']) ?>"
                 alt="<?= escape($article['image_alt']) ?>">
            <p class="alt"><strong>Alt text:</strong> <?= escape($article['image_alt']) ?></p>
        ...
        <section class="text">
          <div class="form-group">
            ...
            <input type="text" name="title" id="title" value="<?= escape($article['title']) ?>"
                   class="form-control">
          ...
          <div class="form-group">
            ...
            <textarea name="summary" id="summary"
                      class="form-control"><?= escape($article['summary']) ?></textarea>
            <span class="errors"><?= $errors['summary'] ?></span>
          </div>
          <div class="form-group">
            <label for="content">Content: </label>
            <textarea name="content" id="content"
                      class="form-control"><?= escape($article['content']) ?></textarea>
            ...
            <select name="member_id" id="member_id">
              <?php foreach ($authors as $author) { ?>
                <option value="<?= $author['id'] ?>"
                    ...
                    <?= escape($author['forename'] . ' ' . $author['surname']) ?></option>
              <?php } ?>
            </select>
