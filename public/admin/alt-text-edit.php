  ...
  <main class="container admin" id="content">
    <form action="alt-text-edit.php?id=<?= $id ?>" method="POST" class="narrow">
      ...
      <div class="form-group">
        ...
        <input type="text" name="image_alt" id="image_alt" value="<?= escape($article['image_alt']) ?>"  class="form-control">
      ...
      <img src="../uploads/<?= escape($article['image_file']) ?>" alt="<?= $article['image_alt'] ?>">
    </form>
  </main>
